...
CORES_MAP_PT = {
    ...
    'marrom': '#8B4513',
    'marsala': '#8B4545',
    # Nomes de cor mais sofisticados/de marca (comuns em briefing de estética premium)
    'taupe': '#8A7660',
    'champagne': '#C6A15C',
    'creme': '#F8F3EB',
    'grafite': '#332B22',
...
"""
    ...
    sistema_edicao = """
SEM BOTAO DE EDICAO!
A pagina e ESTATICA depois de criada -- o cliente recebe o link pronto pra usar.
NAO adicione nenhum botao de edicao, modal de edicao, nem assets/config.json com
sistema de edicao. Isso inclui: nao criar elemento com texto "Editar Pagina",
nao criar nenhum modal/painel fixo no canto da tela pra editar conteudo, e nao
gerar JS que abre/fecha um editor.
"""
